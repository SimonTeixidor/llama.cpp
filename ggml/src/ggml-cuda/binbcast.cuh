...
void ggml_cuda_op_weighted_expert_sum(ggml_backend_cuda_context & ctx, const ggml_tensor * experts, const ggml_tensor * weights, ggml_tensor * dst, int n_expert_used);
